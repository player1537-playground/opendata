            ...
            function update() {
                ...
                if (!init) {
                    ...
                    var transformed = data.map(function(d, i) {
                        var ret = [lat(d, i), lng(d, i)];
                        ret.orig = d;
                        if (i < 10) console.log(lat(d, i), lng(d, i), ret);
                        return ret;
                    });
                    ...
                    L.layerGroup(voronoi(transformed).map(function(d, i) {
                        if (i < 10) console.log(d);
                        return L.polygon(d, {
                            color: color(d.point.orig, i),
                            stroke: false
                        });
...
queue()
    .defer(d3.json, "/clusters/201505/4")
    .defer(d3.json, "/approximate/4")
